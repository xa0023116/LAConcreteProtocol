...
typedef enum {
     ...
     */
    la_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    la_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    la_propertyMemoryManagementPolicyCopy
} la_propertyMemoryManagementPolicy;
...
#pragma clang diagnostic ignored "-Wpadded"
     ...
     */
    la_propertyMemoryManagementPolicy memoryManagementPolicy;
 ...
 */
Class *la_copySubclassList (Class aClass, unsigned *subclassCount);
 ...
 */
unsigned la_injectMethods (Class aClass, Method *methods, unsigned count, la_methodInjectionBehavior behavior, la_failedMethodCallback failedToAddCallback);
 ...
 */
BOOL la_injectMethodsFromClass (Class srcClass, Class dstClass, la_methodInjectionBehavior behavior, la_failedMethodCallback failedToAddCallback);
